...
The snake tournament application needs comprehensive testing for its core game service to ensure reliability and prevent regressions. Currently, there are no automated tests for the internal/services/game.go service, which handles critical game logic including snake movements, food generation, collision detection, and game state management. Creating a proper test container for this service will enable developers to write effective unit and integration tests, improving code quality and maintainability.

## What Changes

- Introduce a test container setup for the game service
